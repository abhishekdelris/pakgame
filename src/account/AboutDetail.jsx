        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 mx-auto bg-color h-100vh pt-3">
            <div className="about-detail-content">
                ...
                <br />
                <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to </p>
                <br />
                ...
                <p>Website refers to PakGames, accessible from </p>
                ...
                <br />
                <p>By visiting this page on our website: PakGames</p>
