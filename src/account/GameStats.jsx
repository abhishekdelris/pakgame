      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 mx-auto bg-color h-100vh">
            <div className="game-statistics-top">
              {/* Nav tabs */}
              ...
              <div className="tab-content" id="pills-tabContent">
                <div
                  className={`tab-pane fade ${
                    activeTab === "today" ? "show active" : ""
                  }`}
                  role="tabpanel"
                  id="today"
                >
                  <div className="game-statistics-content">
                    <h5>Rs 0.00</h5>
                    <p>Total bet</p>
                  </div>
                </div>
                <div
                  className={`tab-pane fade ${
                    activeTab === "yesterday" ? "show active" : ""
                  }`}
                  role="tabpanel"
                  id="yesterday"
                >
                ...
                <div
                  className={`tab-pane fade ${
                    activeTab === "thisweek" ? "show active" : ""
                  }`}
                  role="tabpanel"
                  id="thisweek"
                >
                ...
                <div
                  className={`tab-pane fade ${
                    activeTab === "thismonth" ? "show active" : ""
                  }`}
                  role="tabpanel"
                  id="thismonth"
                >
