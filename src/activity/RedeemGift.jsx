      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 mx-auto bg-color px-0">
            <div className="redeem-gift-header">
              <img
                src="https://pakgames.net/assets/png/gift-d7507b9b.png"
                className="img-fluid"
                alt=""
              />
            </div>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 mx-auto bg-color h-100vh pt-3">
                <div className="redeem-gift-content">
                    <p>Hi</p>
                    <p>We have a gift for you</p>
                    <h5>Please enter the gift code below</h5>
                    <input type="text" placeholder="Please enter gift code" />
                    <button>Receive</button>
                </div>
                <div className="super-jackpot-empty mt-3">
